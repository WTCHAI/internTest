...
export default function LogItem({key,item} : Props) {
  const curerntDate = new Date(parseInt(item.timestamp)*100)
  return (
    <div
    ...
    >
      ...
      <span className="flex justify-center w-full text-gray-500 text-base font-medium">{curerntDate.toLocaleDateString()}</span>
